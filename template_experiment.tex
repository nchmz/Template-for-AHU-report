...
\section{宽幅内容切换示例}
默认采用双栏排版，遇到需要整页宽度的图片或表格时，可以使用类提供的命令临时切换至单栏并自动恢复页眉、页脚与背景。

\AHUOneColumn
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{pic/transistor_usage.png}
    \caption{跨栏展示的大图示例（单栏模式）}
    \label{fig:wide-transistor}
\end{figure}
\AHUTwoColumn
